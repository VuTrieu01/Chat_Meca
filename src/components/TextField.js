  ...
  return (
    <div className={`${props.sx}`}>
      <div className="relative h-10 w-full min-w-[200px]">
        ...
        {props.children ? (
          <div
            className="absolute inset-y-0 right-0 px-2 m-1 flex items-center justify-center text-lg text-slate-400 cursor-pointer rounded-full hover:text-green-600"
